    ...
    <div className="max-w-5xl font-mono">
      ...
      <div className="flex justify-between items-start mb-10">
        <div>
          ...
          <h1 className="text-4xl font-black text-white">EDIT_PROJECT<span className="animate-pulse text-accent">_</span></h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white/[0.02] border border-white/10 p-8">
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <input name="title" required defaultValue={project.title} className="w-full bg-white/5 border border-white/10 p-4 text-sm focus:border-accent outline-none transition-all" />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] text-white/40 uppercase tracking-widest font-bold">Developer_Role</label>
              <input name="role" required defaultValue={project.role} className="w-full bg-white/5 border border-white/10 p-4 text-sm focus:border-accent outline-none transition-all" />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] text-white/40 uppercase tracking-widest font-bold">External_Link (Optional)</label>
              <input name="link" defaultValue={project.link ?? ""} className="w-full bg-white/5 border border-white/10 p-4 text-sm focus:border-accent outline-none transition-all" placeholder="https://itch.io/..." />
            </div>
          </div>
          <div className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] text-white/40 uppercase tracking-widest font-bold">Quick_Summary</label>
              <textarea name="desc" required rows={8} defaultValue={project.desc} className="w-full bg-white/5 border border-white/10 p-4 text-sm focus:border-accent outline-none transition-all resize-none" />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-8 p-6 bg-white/[0.02] border border-white/10">
          <label className="flex items-center gap-3 cursor-pointer group">
            <input type="checkbox" name="homeDisplay" defaultChecked={project.homeDisplay} className="w-4 h-4 accent-accent" />
          ...
          <label className="flex items-center gap-3 cursor-pointer group">
            <input type="checkbox" name="featured" defaultChecked={project.featured} className="w-4 h-4 accent-accent" />

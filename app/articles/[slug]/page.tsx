      ...
      <div className="max-w-7xl mx-auto px-6 pt-10 md:pt-20 pb-20">
        ...
        <article className="max-w-3xl">
          <ReactMarkdown
            ...
            components={{
              h1: ({ children }) => <h1 className="text-3xl font-black text-white mb-6 mt-10">{children}</h1>,
              h2: ({ children }) => <h2 className="text-2xl font-bold text-white mb-4 mt-8 border-b border-white/10 pb-2">{children}</h2>,
              h3: ({ children }) => <h3 className="text-xl font-bold text-white mb-3 mt-6">{children}</h3>,
              p: ({ children }) => <p className="text-white/80 text-lg leading-relaxed mb-5">{children}</p>,
              ...
              blockquote: ({ children }) => (
                <blockquote className="border-l-4 border-[#fed001] pl-6 my-6 text-white/60 italic bg-white/5 py-4 pr-4 rounded-r-xl">{children}</blockquote>
              ),
